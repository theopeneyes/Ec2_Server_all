...
def root(id):
    ...
    if resp['code'] == 200:
        ...
        if file_type.lower()=="mp3" or file_type.lower()=="wav":
            print("Audio file found. Fetching text...")

            google_drive_link = file_path.split('&')[0]

            # Define the local filename for the downloaded video
            input_audio_filename = "/home/ec2-user/AIG-Llama2_Video/" + file_name
            ...
            if len(existing_files) > 0:
                print("File with the same name already exists in the folder. Skipping upload.")
            else:
        ...
        elif file_type.lower()=="mp4" or file_type.lower()=="mkv" or file_type.lower()=="avi" or file_type.lower()=="flv" or file_type.lower()=="mov" or file_type.lower()=="webm" or file_type.lower()=="wmv":
            google_drive_link = file_path.split('&')[0]
